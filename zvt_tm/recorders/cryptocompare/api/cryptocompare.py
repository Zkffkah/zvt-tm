...
https://github.com/lagerfeuer/cryptocompare with modification
"""
import datetime
import time
import typing
...
_URL_PAIRS = 'https://min-api.cryptocompare.com/data/v4/all/exchanges?e={}'

# DEFAULTS
CURR = 'EUR'
LIMIT = 1440
API_KEY = zvt_env['cryptocompare_api_key']
APP_NAME = 'zvt-cryptocompare'
...
def _query_cryptocompare(url: str, errorCheck: bool = True) -> Optional[Dict]:
    ...
    try:
        if API_KEY:
            url = f'{url}&api_key={API_KEY}&extraParams={APP_NAME}'
